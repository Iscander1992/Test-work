    ...
    build: {
        dev: {
            ...
            copy: {
                ...
                'bower_components/swiper/dist/js/swiper.jquery.js':'build/dev/js',
                'bower_components/swiper/dist/css/swiper.css':'build/dev/css'
            },
            settings: {
                NODE_ENV: 'dev'
                // preprocess settings
        ...
        prod: {
            ...
            copy: {
                ...
                'bower_components/swiper/dist/js/swiper.jquery.min.js' : 'build/prod/js'
            },
            settings: {
                NODE_ENV: 'prod'
                // preprocess settings
